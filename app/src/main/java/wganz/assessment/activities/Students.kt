...
import wganz.assessment.adapters.AdapterStudents
import java.io.IOException

class Students : AppCompatActivity() {
    lateinit var progress:ProgressBar
    lateinit var listView_details: ListView
    var arrayList_details:ArrayList<ModelStudents> = ArrayList();
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(isNetworkAvailable(this)) {
            run("https://www.potterapi.com/v1/characters/?key=$2a$10$1JEnmtEF417yBaFZcr51qukRjaKv8d5toEG5DKP/IUZWIVwfsaF7y")
        }
        else{
    ...
    fun run(url: String) {
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                runOnUiThread {
                    val obj_adapter : AdapterStudents
