...
import wganz.assessment.adapters.AdapterHouses
import java.io.IOException

class Houses : AppCompatActivity() {
    lateinit var progress:ProgressBar
    lateinit var listView_details: ListView
    var arrayList_details:ArrayList<ModelHouses> = ArrayList();
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                for (i in 0.. size-1) {
                    ...
                    var model:ModelHouses= ModelHouses();
...
//                    model.school=json_objectdetail.getString("school")
                ...
                runOnUiThread {
                    val obj_adapter : AdapterHouses
                    obj_adapter = AdapterHouses(applicationContext,arrayList_details)
